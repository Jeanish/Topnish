...
import { login,register,profile, sendOTPHandlerOfEmail,sendOTPHandler, verifyOTP } from '../controller/user.controller.js'
...
router.route("/send-email-otp").post(otpRateLimiter,sendOTPHandlerOfEmail)
